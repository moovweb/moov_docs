...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Classes</h3><ul><li><a href="Perf.html">Perf</a><ul class='methods'><li data-type='method'><a href="Perf.html#.selector#optimizeImg">selector#optimizeImg</a></li><li data-type='method'><a href="Perf.html#.selector#quality">selector#quality</a></li><li data-type='method'><a href="Perf.html#blacklistContains">blacklistContains</a></li><li data-type='method'><a href="Perf.html#ignore">ignore</a></li><li data-type='method'><a href="Perf.html#ignored">ignored</a></li><li data-type='method'><a href="Perf.html#optimizedAttrs">optimizedAttrs</a></li><li data-type='method'><a href="Perf.html#optimizeImageAttribs">optimizeImageAttribs</a></li></ul></li></ul><h3>Modules</h3><ul><li><a href="module-moov_perf.html">moov_perf</a></li></ul>
</nav>
...
function Perf(selector) {
    ...
    /**
     * Rewrites image source tags to point to the Moovweb Image Optimizer.
     * @param {Object.&lt;string, Object>} options options of attributes
     ...
     * => "//opt.moovweb.net/img?img=http://www.moovweb.com/selfie.jpg&amp;linkEncoded=0&amp;width=777&amp;height=666&amp;preserve_aspect_ratio=1&amp;quality=88&amp;format=webp"
     *
     */
...
Perf.prototype.optimizedAttrs = function (src, opts) {
    ...
    if (this.blacklistContains(parsed_src.host)) {
        ...
        let encoding_flag = '0';
        // Havent ported the following logic yet
        //         TODO: support setting the base64 encoding flag scope-wide like in tritium
        //         yield() // what does this do in the Tritium context? apply more transforms?
        //         // This tests for whether the URL should be base64 encoded
        //         match(perf.$link_encoded, 'true') {
        //             %url {
        //                 set(encode64(%url))
        //             }
        //             %encoding_flag {
        ...
        if (attrs.width !== undefined) {
            ...
            if (attrs.height === undefined) {
                ...
                if (attrs.preserve_aspect_ratio !== false) {
                    opt_url += '&amp;preserve_aspect_ratio=' + '1';
                }
            }
        }
