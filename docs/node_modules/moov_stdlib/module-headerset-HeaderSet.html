...
<div id="main">
    ...
    <h1 class="page-title">HeaderSet</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-headerset.html">module:headerset</a>~</span>
...
<article>
    ...
    <h4 class="name" id="HeaderSet"><span class="type-signature"></span>new HeaderSet<span class="signature">(type, rawHeaders)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>&quot;request&quot; or &quot;response&quot;.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>rawHeaders</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="headerset.js.html">headerset.js</a>, <a href="headerset.js.html#line15">line 15</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-headerset-HeaderSet_fns.html">fns</a></dt>
            <dd></dd>
        </dl>
    ...
    <h4 class="name" id="addHeader"><span class="type-signature"></span>addHeader<span class="signature">(key, val)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Header key.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="headerset.js.html">headerset.js</a>, <a href="headerset.js.html#line172">line 172</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="header"><span class="type-signature"></span>header<span class="signature">(key, val)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set or replace existing header.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="headerset.js.html">headerset.js</a>, <a href="headerset.js.html#line154">line 154</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="removeAllHeaders"><span class="type-signature"></span>removeAllHeaders<span class="signature">(key)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Remove all matching header.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="headerset.js.html">headerset.js</a>, <a href="headerset.js.html#line191">line 191</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="removeHeader"><span class="type-signature"></span>removeHeader<span class="signature">(key)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Remove last matching header.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="headerset.js.html">headerset.js</a>, <a href="headerset.js.html#line181">line 181</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="headerset.js.html">headerset.js</a>, <a href="headerset.js.html#line207">line 207</a>
    </li></ul></dd>
...
<footer>
    Documentation generated at Wed Oct 07 2015 14:26:34 GMT-0700 (PDT)
</footer>
